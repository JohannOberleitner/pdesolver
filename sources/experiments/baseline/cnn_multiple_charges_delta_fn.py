...
def calc_charge_delta_func_weight_matrix(geometry, chargeDistribution, index=0):
    matrix = np.zeros(shape=(len(geometry.Y), len(geometry.X)))
    charge_by_index = chargeDistribution.chargesList[index]
...
class TrainingSet_CreationStrategy_delta_func_m_MultiCharge_Zeros(TrainingSet_CreationStrategy_m_MultiCharge_Zeros):

    def __init__(self, geometry, N, charges_count):
        self.N = N
        super(TrainingSet_CreationStrategy_delta_func_m_MultiCharge_Zeros, self).__init__(geometry, N, charges_count)
    ...
    def calc_weight_matrix_list(self, index, charge, charges_list):
        ...
        for charge_index in range(0, m):
            charges_weight_matrix_list.append(calc_charge_delta_func_weight_matrix(self.geometry, charge, charge_index))
...
if __name__ == '__main__':
    ...
    if readFile == None:
        ...
        fill_strategy = TrainingSet_CreationStrategy_delta_func_m_MultiCharge_Zeros(pde.geometry, N=count,
