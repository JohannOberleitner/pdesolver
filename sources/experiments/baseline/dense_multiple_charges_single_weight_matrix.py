...
class TrainingSet_CreationStrategy:
    ...
    def get_charges_count_for_inputset(self):
        return self.charges_count

    def create_inputSet(self):
        self.prepare()
        self.charges = []
        self.input_set = np.zeros(shape=(self.N, self.gridWidth, self.gridHeight, self.get_charges_count_for_inputset()))
...
class TrainingSet_CreationStrategy_MultiCharge_SingleWeightMatrix(TrainingSet_CreationStrategy):

    def __init__(self, geometry, N, charges_count):
        self.N = N
        super(TrainingSet_CreationStrategy_MultiCharge_SingleWeightMatrix, self).__init__(geometry, charges_count)
    ...
    def calc_weight_matrix_list(self, index, charge, charges_list):
        ...
        charges_weight_matrix_list.append(calc_charge_weight_matrix_multi(self.geometry, charge))
...
if __name__ == '__main__':
    ...
    model = make_model(architectureType, (int)(gridSize), (int)(gridSize), 1)
    ...
    if readFile == None:
        ...
        fill_strategy = TrainingSet_CreationStrategy_MultiCharge_SingleWeightMatrix(pde.geometry, N=count, charges_count=charges_count)
